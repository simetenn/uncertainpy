...
#
#
#         self.assertEqual(self.plot.t_compare.keys(), ['mc_10', 'mc_100'])
#         self.assertEqual(self.plot.U_compare.keys(), ['mc_10', 'mc_100'])
#         self.assertEqual(self.plot.E_compare.keys(), ['mc_10', 'mc_100'])
#         self.assertEqual(self.plot.Var_compare.keys(), ['mc_10', 'mc_100'])
#         self.assertEqual(self.plot.p_05_compare.keys(), ['mc_10', 'mc_100'])
#         self.assertEqual(self.plot.p_95_compare.keys(), ['mc_10', 'mc_100'])
#         self.assertEqual(self.plot.sensitivity_compare.keys(), ['mc_10', 'mc_100'])
