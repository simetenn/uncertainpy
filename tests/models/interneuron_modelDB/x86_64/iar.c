...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 iar /home/docker/uncertainpy/tests/models/interneuron_modelDB/x86_64/iar.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/docker/uncertainpy/tests/models/interneuron_modelDB/iar.mod";
static const char* nmodl_file_text = 
