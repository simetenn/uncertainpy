...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 iahp /home/docker/uncertainpy/tests/models/interneuron_modelDB/x86_64/iahp.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/docker/uncertainpy/tests/models/interneuron_modelDB/iahp.mod";
static const char* nmodl_file_text = 
