...
# -*- coding: utf-8 -*-
#
# uncertainpy documentation build configuration file, created by
...
project = u'Uncertainpy'
copyright = u'2017, Simen Tennøe'
author = u'Simen Tennøe'
...
htmlhelp_basename = 'uncertainpydoc'
