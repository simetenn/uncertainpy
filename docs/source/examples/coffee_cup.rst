...
:download:`examples/coffee_cup/uq_coffee_function.py <../../../examples/coffee_cup/uq_coffee_function.py>`.
...
:download:`examples/coffee_cup/uq_coffee_class.py <../../../examples/coffee_cup/uq_coffee_class.py>`.
